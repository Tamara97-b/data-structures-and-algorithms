...
// console.log(removeThree(4, [1, 2, 3, 4, 5, 6, 7, 8, 9]));
...
// console.log(joinArray(["hello", "301", "students"]));
...
const howMuchPencil = (str) => {
  ...
  for (let i = 0; i < str.length + 1; i++) {
    // result.push(joinStr);
    // strArr = joinStr.split("");
    // spliceStr = strArr.splice(1, strArr.length);
    // joinStr = spliceStr.join("");
...
// console.log(wordsToCharList("gregor"));
